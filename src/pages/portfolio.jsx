...
function Portfolio() {
	return (
		<>
			...
			<TextBlock title="Previous Programming Work">
				Below you'll find some modals which highlight, detail, and
				concisely put together projects I've worked on in the past. For
				all intents and purposes, these are complete as they finish out
				the goal they were initially intended to pursue, although I may
				make updates here and there where necessary.
			</TextBlock>
			...
			<TextBlock title="Current Projects">
				Much like the above category, below you'll find modals
				showing some projects I'm currnetly working on, in as much
				detail as I'm allowed to offer.
			</TextBlock>
			<div className="flex justify-between">
				<SquareProjectModal
					...
					image="">
						A 2D Shoot-Em-Up game engine & game created entirely within C/C++ with the use of the Simple DirectMedia Layer 3 library. Purpose built to be compiled to and played perfectly on consoles as old as the PlayStation 1.
					</SquareProjectModal>
				<SquareProjectModal
					link="https://github.com/rydal05/ohmyzsh-plugin-manager"
					title="OMZ Plugin Manager"
					image="">
						A plugin manager for OhMyZsh written in Rust. Purpose built for quick and easy enabling, disabling, insallation, and deletion of plugins for the Zsh shell config tool. I found the builtin plugin manager to be clunky and odd to work with, so I'm writing my own. Some features included that win it out over the builtin is installation of 3rd party omz plugins and quicker configuration without having to meddle with extra files.
					</SquareProjectModal>
				<SquareProjectModal
			...
			<TextBlock title="Hackathons">
				Here you'll see some projects I collaborated with others
				on for hackathons. I've attended 2 hackathons thus far, my first
				being Knight Hacks VIII in October of 2025.
			</TextBlock>
			...
			<div className="flex justify-between">
				<SquareProjectModal
					...
					title="CourseKnight"
					image="">
						A Discord Guild bot that automatically fecthes canvas webcourse updates. New grades, assignments, and teacher announcements, all with the help of Google Gemini to provide summaries and encouraging words of advice.
					</SquareProjectModal>
				<SquareProjectModal
					...
					image=""
					>
						An open source JIRA subquivalent designed to showcase open source repos on github that have large deficits in their issues to pull request ratios. Intended to help intermediate devs find projects to work on and help projects gain contributors.
					</SquareProjectModal>
			</div>
			<br />
			<hr />
