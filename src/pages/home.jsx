						...
						<div className="flex gap-8">
							...
							<div className="flex flex-row gap-4">
								<span className="expandable">
									<a href="https://github.com/rydal05">
										<svg
								...
								<span className="expandable">
									<a href="https://www.instagram.com/okay.ryn/">
										<svg
											className="border rounded-4xl border-[#e94f37] p-1 w-10  h-10 "
											stroke="currentColor"
											fill="currentColor"
				...
				<div className="flex justify-between">
					...
					>
						<ul>
							...
							<li>
								Moved to Orlando from West Palm Beach at 18
								years old and started at Valencia College.
							</li>
						</ul>
						<br />
					</TextBlock>
					...
					>
						<ul>
							...
							<li>
								Transferred to UCF via the DirectConnect
								program.
							</li>
						</ul>
					</TextBlock>
					...
					>
						<ul>
							...
							<li>
								I intend to take up a minor in math and
								engineering in the near future
							</li>
							<li>
								I participate in the Hack@UCF and KnightHacks
								club, and look forward to joining the Satalite
								club. Avid participant of KnightHacks hackathons
								and other events posted by computer clubs.
							</li>
						</ul>
					</TextBlock>
					...
					>
						...
						doctorate somewhere in the computer science field.
						Although I'm not 100% where I'll take it, I know my love
						for computers will land me here eventually.
					</TextBlock>
				</div>
