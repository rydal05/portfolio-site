	...
	return (
		<>
			<div>
				<h1>Who am I?</h1>
				<p>
					Hi, I'm Ryan. I am currently pursuing my undergrad degree at
					the University of Central Florida for Computer Science.
				</p>
			</div>
			...
			<div>
				<h1>What do I do?</h1>
				<p>
					Professionally I enjoy software development, more
			...
			<div>
				...
				<p>
					I develop almost exclusively on Linux, rotating between
					...
					addition to frameworks like React and Svelte (with Vite).
				</p>
			</div>
			...
			<div>
				...
				<p>
					The dream since middle school has always been to put into
