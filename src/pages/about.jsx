		...
		<>
			...
			<div>
				<TextBlock
					...
					text="I develop almost exclusively on Linux, rotating between Arch, Fedora, and LMDE (Debian) primarily with C/C++, Python, and whatever wildcard langauge I've determined is required to get a certain job done. As far as webdev is concerned, I've worked with the usual HTML+CSS+JS in addition to frameworks like React and Svelte (with Vite). Sometimes I'll switch over to Windows when working on specific projects like things involving .NET or GPU/DLL injection stuff."
				/>
			</div>
